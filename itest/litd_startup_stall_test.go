...
const (
	...
	// maxResolutionBlocks bounds how many blocks we mine to drive the
	// force close to resolution. Each block gives the sweeper another
	// blockbeat to retry on, so this also bounds how many retries we are
	// willing to wait for.
